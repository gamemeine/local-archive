...
android {
    namespace = "com.example.local_archive"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.local_archive"
        ...
        manifestPlaceholders += mapOf(
            "auth0Domain" to "dev-y5sk84ei4zmzfbxz.us.auth0.com",
            "auth0Scheme" to "com.example.localarchive"
        )
       packagingOptions {
